...
version_line=`grep '^  VERSION =' bin/ximapd`
version=`expr "$version_line" : '  VERSION = "\(.*\)"'`
svn copy -m "tagged version $version" https://projects.netlab.jp/svn/ximapd/branches/0.0 https://projects.netlab.jp/svn/ximapd/tags/$version
